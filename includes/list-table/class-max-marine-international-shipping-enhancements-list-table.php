 ...
 * @subpackage Max_Marine\International_Shipping_Enhancements/admin
 * @author     David Baumwald <david@dream-encode.com>
 */

namespace Max_Marine\International_Shipping_Enhancements\Core\ListTable;
 ...
 * @author     David Baumwald <david@dream-encode.com>
 */
class Max_Marine_International_Shipping_Enhancements_List_Table extends WP_List_Table {
	...
	public function __construct() {
		parent::__construct(
			array(
				'singular' => __( 'Thing', 'max-marine-international-shipping-enhancements' ),
				'plural'   => __( 'Things', 'max-marine-international-shipping-enhancements' ),
				'ajax'     => false,
			)
		);
	}
	...
	public function no_items() {
		esc_html_e( 'No things.', 'max-marine-international-shipping-enhancements' );
	}
	...
	public function column_default( $item, $column_name ) {
		switch ( $column_name ) {
			case 'timestamp':
				...
				if ( ! $date ) {
					$date = __( 'N/A', 'max-marine-international-shipping-enhancements' );
				}
	...
	public function get_columns() { // @phpcs:ignore @phpstan-ignore-line
		$columns = array(
			'timestamp' => __( 'Date', 'max-marine-international-shipping-enhancements' ),
			'id'        => __( 'ID', 'max-marine-international-shipping-enhancements' ),
		);
