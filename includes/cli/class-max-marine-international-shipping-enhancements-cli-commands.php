<?php
/**
 * Class Max_Marine_International_Shipping_Enhancements_CLI_Commands
 *
...
namespace Max_Marine\International_Shipping_Enhancements\Core\CLI;
 ...
 * @since 1.0.0
 */
final class Max_Marine_International_Shipping_Enhancements_CLI_Commands {
	/**
	 * Example command.
	 *
	 * @since  1.0.0
	...
	public function example_command( $args, $assoc_args ) {
		...
		if ( $dry_run ) {
			WP_CLI::line(
				__( 'Dry run only.', 'max-marine-international-shipping-enhancements' )
			);
		}
	}
}
