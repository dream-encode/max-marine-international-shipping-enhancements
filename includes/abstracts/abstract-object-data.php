<?php
/**
 * Class Max_Marine_International_Shipping_Enhancements_Abstract_Object_Data.
 *
 * @since 1.0.0
 */
...
if ( ! class_exists( 'Max_Marine_International_Shipping_Enhancements_Abstract_Object_Data' ) ) {

	/**
	 * Class Max_Marine_International_Shipping_Enhancements_Abstract_Object_Data
	 */
	abstract class Max_Marine_International_Shipping_Enhancements_Abstract_Object_Data {
		/**
		 * ID.
		 *
		 * @var int
		...
		/**
		 * Max_Marine_International_Shipping_Enhancements_Abstract_Object_Data constructor.
		 *
			...
			if ( $errors ) {
				...
				throw new Exception(
					sprintf(
						...
						__( 'The following functions %1$s do not exists in %2$s', 'max-marine-international-shipping-enhancements' ),
						implode( ',', $errors ),
						get_class( $this )
					)
				);
