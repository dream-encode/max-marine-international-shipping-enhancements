 ...
 * @since      1.0.0
 *
 * @package    Max_Marine_International_Shipping_Enhancements/includes/abstracts
 */

namespace Max_Marine\International_Shipping_Enhancements\Core\Abstracts;
 ...
 *
 * @package  Max_Marine\International_Shipping_Enhancements\Core\Abstracts\Max_Marine_International_Shipping_Enhancements_Abstract_WC_Logger
 * @author   David Baumwald <david@dream-encode.com>
 */
class Max_Marine_International_Shipping_Enhancements_Abstract_WC_Logger {
	 ...
	 */
	protected static $namespace = 'max-marine-international-shipping-enhancements';
	...
	public static function log( $data, $level = 'debug' ) {
		...
		$log_level_setting = max_marine_international_shipping_enhancements_get_plugin_setting( 'log-level', 'off' );
		...
		if ( ! function_exists( 'wc_get_logger' ) ) {
			...
			error_log(
				sprintf(
					...
					__( '%1$s->%2$s depends on `wc_get_logger` which is bundled with the WooCommerce plugin.', 'max-marine-international-shipping-enhancements' ),
					__CLASS__,
					__METHOD__
				)
			);
