...
export const convertTimestampToFriendlyDate = ( timestamp ) => {
	if ( ! timestamp ) {
		return __( 'N/A', 'max-marine-international-shipping-enhancements' )
	}
...
export const wpEditPostLinkFromPostId = ( postID ) => {
	return addQueryArgs( `${ mmise.ADMIN_URL }post.php`, { post: postID, action: 'edit' } )
}